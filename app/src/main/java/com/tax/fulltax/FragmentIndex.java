...
import java.util.List;
 ...
 public  class FragmentIndex {
      ...
      FragmentIndex(){
        fragmentIndex.add(new YearsFragment(1981,1993,new UniformTaxFragment(), new UniformTaxFragment_Commercial() ) );
        fragmentIndex.add(new YearsFragment(1994,2004,new UniformTaxFragment_Mowahada(), null ) );
