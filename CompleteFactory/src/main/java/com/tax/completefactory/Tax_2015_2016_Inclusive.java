...
public class  Tax_2015_2016_Inclusive implements ITax {
    ...
    Tax_2015_2016_Inclusive(double taxBase, com.tax.completefactory.TaxPersonType taxPersonType){
    ...
    com.tax.completefactory.TaxRule_2015_2016_Inclusive theTaxRule=new TaxRule_2015_2016_Inclusive();
    ...
    public String get_WhichRuleAmI(){
        return  theTaxRule.lawInfo;//return "Tax_From_To_2015_2016_Inclusive" + "\n" + theTaxRule.lawInfo;
    }
